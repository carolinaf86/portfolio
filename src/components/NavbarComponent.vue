<template>
  <b-navbar toggleable="lg" fixed="top" :class="{ 'navbar-shrink': shrinkNav }" v-b-scrollspy id="mainNav">
    <div class="container">
      ...
      <b-collapse is-nav id="navbarResponsive">
        ...
        <b-navbar-nav class="ml-auto">
          ...
          <template v-if="$route.path === '/cv'">
            <b-nav-item href="#name-row" v-scroll-to="{el: '#name-row', offset: -80}">About</b-nav-item>
            <b-nav-item href="#skills-row" v-scroll-to="{el: '#skills-row', offset: -80}">Skills</b-nav-item>
          ...
          <b-nav-item class="btn btn-sm btn-primary navbar-btn" v-if="$route.path !== '/cv'" to="/cv">CV</b-nav-item>
        </b-navbar-nav>
      </b-collapse>
    </div>
  </b-navbar>
